...
namespace Controllers.PSU.Areas.Administrator
{
    ...
    public class DormitoryController : DanvicController
    {
        #region Initialize
        ...
        public DormitoryController(IDormitoryService service, ILogger<DormitoryController> logger, IHttpContextAccessor httpContextAccessor, ApplicationDbContext context)
        {
            _service = service;
            _logger = logger;
