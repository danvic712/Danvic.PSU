 ...
 *   Author: Danvic712
 */
$(function(){$("input").iCheck({checkboxClass:"icheckbox_flat-green",radioClass:"iradio_flat-green",increaseArea:"20%"});$(".date-picker").datepicker({autoclose:!0,todayHighlight:!0,language:"zh-CN",format:"yyyy-mm-dd"});$(document).on("click","#save",function(){if($("#name").val().length===0)return bootbox.dialog({message:"用户姓名不能为空"}),!1;if($("#idnumber").val().length===0)return bootbox.dialog({message:"身份证号不能为空"}),!1;var n={};n.Id=$(this).attr("data-id");n.Email=$("#email").val();n.Phone=$("#phone").val();n.Name=$("#name").val();n.Gender=$('input:radio[name="gender"]:checked').val();n.Age=$("#age").val();n.Wechat=$("#wechat").val();n.QQ=$("#qq").val();n.TicketId=$("#ticketid").val();n.IdNumber=$("#idnumber").val();n.Birthday=$("#birthday").val();n.HighSchool=$("#highschool").val();n.StartDate=$("#startdate").val();n.EndDate=$("#enddate").val();n.ProvinceId=$("#province").find("option:selected").attr("data-code");n.Province=$("#province").val();n.CityId=$("#city").find("option:selected").attr("data-code");n.City=$("#city").val();n.DistrictId=$("#distinct").find("option:selected").attr("data-code");n.District=$("#distinct").val();n.Address=$("#address").val();n.Hobbies=$("#hobbies").val();n.Winning=$("#winning").val();$(this).attr("disabled","disabled");$.ajax({type:"POST",url:"/Student/User/EditProfile",data:n,dataType:"json",success:function(n){n.msg!==undefined&&(bootbox.dialog({message:n.msg}),n.success&&setTimeout(function(){window.location.href=window.location.href},2e3));$("#save").removeAttr("disabled")},error:function(n){console.log(n);$("#save").removeAttr("disabled")}})})});