/*!
 *   Instructor Register Page JavaScript v1.0.0
 *   Author: Danvic712
 */
...
$.dataTableSetting = {
    ...
    ajax: function (data, callback, settings) {
        ...
        $.ajax({
            type: "POST",
            url: "/Instructor/Newborn/SearchRegister",
            cache: false,  //禁用缓存
            data: {
...
$(function () {
    ...
    var dataTable = $('#register-table').dataTable($.dataTableSetting);

    //search
    $(document).on('click', '#search', function () {
        dataTable.fnDestroy(false);
        dataTable = $('#register-table').dataTable($.dataTableSetting);
    });
})