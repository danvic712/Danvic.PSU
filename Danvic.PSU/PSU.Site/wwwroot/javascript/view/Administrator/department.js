/*!
 *   Administrator Department Page JavaScript v1.0.0
 *   Author: Danvic712
 */
$(function () {
    ...
    $(document).on('click', '#add', function () {
        window.location.href = '/Administrator/School/EditDepartment';
    });

    $(document).on('click', '#detail', function () {
        window.location.href = '/Administrator/School/DepartmentDetail';
    });
